...
export const BODIES: Record<string, CelestialBodyData> = {
  ...
  tethys: {
    ...
    colorHex: 0xe2e8f0,
    observationTip: '寻找奥德修斯巨型撞击坑和绵延数千公里的伊萨卡峡谷；灰度拼图保留了拍摄时的明暗。',
    ...
    colorAssetId: 'tethys-cassini-pia14931-4k',
    sourceRef: 'NASA/JPL-Caltech/Space Science Institute · Cassini PIA14931',
  },
  dione: {
    id: 'dione',
    name: '土卫四',
