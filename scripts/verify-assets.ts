...
export async function main() {
  ...
  const targets = [
    ...
    },
    {
      ...
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_sun.jpg',
      relativeTargetPath: 'assets/textures/sun/2k_sun.jpg',
      expectedWidth: 2048,
      expectedHeight: 1024,
      projection: 'equirectangular' as const,
      longitudeConvention: '0-to-360-east' as const,
      ...
      observationBands: ['visible-light-reconstructed'],
      provenanceClass: 'observation-derived-visualization' as const,
      coverageNotes: '太阳光球层表面视觉图，包含米粒组织与太阳黑子示意。',
      credit: 'Solar System Scope / INOVE',
      licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
      licenseNotes: 'CC BY 4.0 商业与非商业可用，需保留署名。',
    },
    {
      ...
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_mercury.jpg',
      relativeTargetPath: 'assets/textures/mercury/2k_mercury.jpg',
      expectedWidth: 2048,
      expectedHeight: 1024,
      projection: 'equirectangular' as const,
      longitudeConvention: '0-to-360-east' as const,
      ...
      observationBands: ['visible-light-reconstructed'],
      provenanceClass: 'observation-derived-visualization' as const,
      coverageNotes: '基于信使号 (MESSENGER) 探测数据加工的水星全球撞击坑地形纹理。',
      credit: 'Solar System Scope / INOVE / NASA',
      licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
      licenseNotes: 'CC BY 4.0 商业与非商业可用，需保留署名。',
    },
    {
      id: 'venus-atmosphere-sss-2k',
      bodyId: 'venus',
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_venus_atmosphere.jpg',
      relativeTargetPath: 'assets/textures/venus/2k_venus_atmosphere.jpg',
      expectedWidth: 2048,
      expectedHeight: 1024,
      projection: 'equirectangular' as const,
      longitudeConvention: '0-to-360-east' as const,
      ...
      observationBands: ['visible-light-reconstructed'],
      provenanceClass: 'observation-derived-visualization' as const,
      coverageNotes: '金星致密二氧化碳云层厚重大气外观。',
      credit: 'Solar System Scope / INOVE',
      licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
      licenseNotes: 'CC BY 4.0 商业与非商业可用，需保留署名。',
    },
    {
      id: 'venus-surface-sss-2k',
      bodyId: 'venus',
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_venus_surface.jpg',
      relativeTargetPath: 'assets/textures/venus/2k_venus_surface.jpg',
      expectedWidth: 2048,
      expectedHeight: 1024,
      projection: 'equirectangular' as const,
      longitudeConvention: '0-to-360-east' as const,
      ...
      northUp: true,
      colorInterpretation: 'sRGB' as const,
      observationBands: ['radar-altimetry-reconstructed'],
      provenanceClass: 'observation-derived-visualization' as const,
      coverageNotes: '麦哲伦号 (Magellan) 合成孔径雷达穿透测绘的金星岩浆岩与火山平原地表。',
      credit: 'Solar System Scope / INOVE / NASA',
      licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
      licenseNotes: 'CC BY 4.0 商业与非商业可用，需保留署名。',
    },
    {
      ...
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_mars.jpg',
      relativeTargetPath: 'assets/textures/mars/2k_mars.jpg',
      expectedWidth: 2048,
      expectedHeight: 1024,
      projection: 'equirectangular' as const,
      longitudeConvention: '0-to-360-east' as const,
      ...
      observationBands: ['visible-light-reconstructed'],
      provenanceClass: 'observation-derived-visualization' as const,
      coverageNotes: '火星全球氧化铁地表、极地冰盖与水手号峡谷。',
      credit: 'Solar System Scope / INOVE / NASA',
      licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
      licenseNotes: 'CC BY 4.0 商业与非商业可用，需保留署名。',
    },
    {
      ...
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_jupiter.jpg',
      relativeTargetPath: 'assets/textures/jupiter/2k_jupiter.jpg',
      expectedWidth: 2048,
      expectedHeight: 1024,
      projection: 'equirectangular' as const,
      longitudeConvention: '0-to-360-east' as const,
      ...
      observationBands: ['visible-light-reconstructed'],
      provenanceClass: 'observation-derived-visualization' as const,
      coverageNotes: '木星全球条带云层与大红斑风暴，基于卡西尼与旅行者探测器数据加工。',
      credit: 'Solar System Scope / INOVE / NASA',
      licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
      licenseNotes: 'CC BY 4.0 商业与非商业可用，需保留署名。',
    },
    {
      ...
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_saturn.jpg',
      relativeTargetPath: 'assets/textures/saturn/2k_saturn.jpg',
      expectedWidth: 2048,
      expectedHeight: 1024,
      projection: 'equirectangular' as const,
      longitudeConvention: '0-to-360-east' as const,
      ...
      observationBands: ['visible-light-reconstructed'],
      provenanceClass: 'observation-derived-visualization' as const,
      coverageNotes: '土星淡黄色柔和大气条带球体。',
      credit: 'Solar System Scope / INOVE / NASA',
      licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
      licenseNotes: 'CC BY 4.0 商业与非商业可用，需保留署名。',
    },
    {
      id: 'saturn-rings-sss-2k',
      bodyId: 'saturn',
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_saturn_ring_alpha.png',
      relativeTargetPath: 'assets/textures/saturn/2k_saturn_ring_alpha.png',
      expectedWidth: 2048,
      expectedHeight: 125,
      projection: 'equirectangular' as const,
      longitudeConvention: 'standard' as const,
      ...
      northUp: true,
      colorInterpretation: 'sRGB' as const,
      observationBands: ['visible-light-alpha'],
      provenanceClass: 'observation-derived-visualization' as const,
      coverageNotes: '土星主环径向透明度与颜色条带图，包含卡西尼环缝。',
      credit: 'Solar System Scope / INOVE / NASA',
      licenseUrl: 'https://creativecommons.org/licenses/by/4.0/',
      licenseNotes: 'CC BY 4.0 商业与非商业可用，需保留署名。',
    },
    {
      ...
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_uranus.jpg',
      relativeTargetPath: 'assets/textures/uranus/2k_uranus.jpg',
      expectedWidth: 2048,
      expectedHeight: 1024,
      projection: 'equirectangular' as const,
      longitudeConvention: '0-to-360-east' as const,
    ...
    },
    {
      ...
      role: 'color' as const,
      sourcePage: 'https://www.solarsystemscope.com/textures/',
      sourceAssetUrl: 'https://www.solarsystemscope.com/textures/download/2k_neptune.jpg',
      relativeTargetPath: 'assets/textures/neptune/2k_neptune.jpg',
      expectedWidth: 2048,
      expectedHeight: 1024,
      projection: 'equirectangular' as const,
      longitudeConvention: '0-to-360-east' as const,
